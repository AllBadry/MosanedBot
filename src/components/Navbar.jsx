    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          {isLoggedIn ? (
            <Link to="/dashboard" className="hidden md:inline-flex relative group items-center justify-center px-6 py-2.5 font-bold text-white bg-slate-900 rounded-xl overflow-hidden transition-all hover:bg-electric-cyan hover:text-slate-900 hover:shadow-glow">
        ...
        <div className="bg-surface/95 backdrop-blur-md border-t border-slate-100 shadow-lg">
          <div className="px-6 py-4 space-y-2">
            ...
            {isLoggedIn ? (
              <Link
                to="/dashboard"
                className="block px-4 py-3 rounded-xl font-bold text-center bg-slate-900 text-white mt-3"
              >
                📊 لوحة التحكم
              </Link>
            ) : (
