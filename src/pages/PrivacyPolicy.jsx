        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-200/60 space-y-12 leading-relaxed">
          ...
          <section className="group">
            ...
            <p className="text-slate-600 text-lg">
              مرحباً بك في منصة <strong>مساند</strong>. تشرح سياسة الخصوصية هذه كيف نقوم بجمع، استخدام، وحماية بياناتك الشخصية وبيانات زوار موقعك عند استخدامك لخدماتنا والمساعد الذكي <span dir="ltr">(Widget)</span>. نحن نلتزم بأعلى معايير الأمان التقنية والقانونية لضمان سرية معلوماتك.
            </p>
          </section>
          ...
          <section className="group">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                ...
                <p className="text-slate-600">نجمع النطاق <span dir="ltr">(Domain)</span> الخاص بموقعك الإلكتروني كإجراء أمني؛ للتأكد من أن المساعد الذكي يعمل فقط على موقعك المصرح له، ولمنع أي استخدام غير مصرح به لمواردك.</p>
              </div>
              <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
          ...
          <section className="bg-blue-50/50 p-8 rounded-3xl border border-blue-100 relative overflow-hidden">
            ...
            <p className="text-blue-800 leading-relaxed">
              قانونياً، تعتبر منصة <strong>"مساند"</strong> بمثابة <span className="font-bold">معالج البيانات <span dir="ltr">(Data Processor)</span></span> لمحادثات زوارك، في حين تُعتبر <strong>أنت (صاحب الموقع)</strong> <span className="font-bold">المتحكم في البيانات <span dir="ltr">(Data Controller)</span></span>. هذا يعني أنك المسؤول الأول عن إعلام زوار موقعك ضمن سياسة خصوصيتك بأنك تستخدم مساعداً ذكياً يقوم بمعالجة وحفظ المحادثات.
            </p>
          </section>
          ...
          <section className="group">
            ...
            <p className="text-slate-600 text-lg">
              نتخذ تدابير أمنية تقنية وتنظيمية متقدمة لحماية بياناتك من الوصول غير المصرح به. تشمل هذه التدابير تشفير كلمات المرور، استخدام بروتوكولات الاتصال الآمن <span dir="ltr">(HTTPS)</span>، وتخزين البيانات في خوادم سحابية محمية بأنظمة جدار حماية <span dir="ltr">(Firewalls)</span> خاضعة للمراقبة المستمرة.
            </p>
          </section>
