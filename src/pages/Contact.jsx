            ...
            <div className="contact-info-card opacity-0 bg-surface p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden group">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="pt-6 border-t border-slate-100 flex gap-4">
                  <a href="https://www.facebook.com/UboorTech" target="_blank" rel="noopener noreferrer" className="contact-item opacity-0 flex items-center gap-2 bg-slate-50 border border-slate-200 hover:bg-[#1877F2]/10 hover:border-[#1877F2]/30 px-4 py-2 rounded-xl transition-colors group/social">
                  ...
                  <a href="https://github.com/Uboor-Company" target="_blank" rel="noopener noreferrer" className="contact-item opacity-0 flex items-center gap-2 bg-slate-50 border border-slate-200 hover:bg-slate-800 hover:border-slate-800 px-4 py-2 rounded-xl transition-colors group/social">
